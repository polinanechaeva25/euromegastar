...
from .views import MainListView, AboutListView, NewsListView, FirstProductListView, SecondProductListView, \
    ThirdProductListView, ContactListView, DocsListView
...
urlpatterns = [
    ...
    path('docs/', DocsListView.as_view(), name='docs'),
